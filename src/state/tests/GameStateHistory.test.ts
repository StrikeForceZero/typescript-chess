...
describe('GameStateHistory', () => {
  describe('pgn', () => {
    ...
    it('should maintain entries (check)', () => {
      ...
      game.move(BoardPos.D1, BoardPos.E2);
    ...
    it('should maintain entries (castle)', () => {
      ...
      game.move(BoardPos.E1, BoardPos.G1);
      game.move(BoardPos.E8, BoardPos.D1);
    ...
    it('should maintain entries (ambiguous rank)', () => {
      ...
      game.move(BoardPos.G1, BoardPos.F1);
      expect(game.gameState.history.pgn[0]?.buildString()).toBe('1. Rgf2');
    });
    it('should maintain entries (ambiguous file)', () => {
      loadScenario('k7/8/8/8/8/6R1/8/K3R1R1 w - - 0 1' as FENString);
      game.move(BoardPos.G1, BoardPos.G2);
