 ...
 */
export function asSimpleEnum<T extends Record<K, V>, K extends PropertyKey, V>(obj: T): ReadonlyDeep<SimpleEnum<T, K, V>> {
 ...
 */
export function asSimpleConstEnum<const T extends Record<K, V>, const K extends PropertyKey, const V>(obj: T): ReadonlyDeep<SimpleEnum<T, K, V>> {
  return deepFreeze(obj);
}
